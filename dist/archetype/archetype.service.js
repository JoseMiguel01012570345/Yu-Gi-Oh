...
let ArchetypeService = class ArchetypeService {
    constructor(archetypeRepository) {
        this.archetypeRepository = archetypeRepository;
    }
    async create(createArchetypeInput) {
    ...
    async update(id, updateArchetypeInput) {
...
exports.ArchetypeService = ArchetypeService = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, typeorm_1.InjectRepository)(archetype_entity_1.Archetype)),
