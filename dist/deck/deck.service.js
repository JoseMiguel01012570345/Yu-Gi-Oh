    ...
    async create(createDeckInput) {
        try {
            ...
            return {
                ...
                deckID: `${(await this.findAll()).length}`
            };
        }
        catch (error) {
